# AGENTS.md - `ditt-sykefravaer`
Repoet `ditt-sykefravaer` er en React-app for oversiktssiden om sykepenger i Nav.
Den har også undersiden for innsending av sykmeldinger og visning av inntekstmeldinger.
...
npm run play-headless-build # kjør E2E-tester i headless mode (brukes i CI)
```
