...
function setUpMock(persona: Persona) {
    mock.get('/syk/sykefravaer/api/v1/meldinger', (req, res, ctx) => res(ctx.json(persona.meldinger)))

    mock.post('/syk/sykefravaer/api/v1/meldinger/:id/lukk', (req, res, ctx) => res(ctx.json({ lukket: 'ok' })))
    ...
    mock.get('/syk/sykefravaer/api/v1/vedtak', (req, res, ctx) => res(ctx.json(persona.vedtak)))

    mock.get(`${syfoApiRoot()}/syfooppfolgingsplanservice/api/arbeidstaker/oppfolgingsplaner`, (req, res, ctx) =>
    ...
    mock.get('/syk/sykefravaer/api/v1/sykmeldinger', (req, res, ctx) => res(ctx.json(persona.sykmeldinger)))

    mock.get('/syk/sykefravaer/api/v1/narmesteledere', (req, res, ctx) => res(ctx.json(persona.narmesteledere)))
