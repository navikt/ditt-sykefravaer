...
import '../pages/aktivitetskrav/aktivitetskrav.less'
import '../pages/forside/forside.less'
import '../pages/snart-slutt/snartslutt.less'
import '../pages/tidslinjen/tidslinjen.less'
