...
import { dialogmoteUrl, oppfolgingsplanUrl, sykepengesoknadUrl } from '../../utils/environment'
...
function Oppgaver() {
    ...
    const sykmeldingOppgaver = skapSykmeldingoppgaver(sykmeldinger, '/sykmeldinger')
