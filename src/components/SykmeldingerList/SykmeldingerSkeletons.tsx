...
export function SykmeldingerListSkeleton(): ReactElement {
    return (
        <section aria-labelledby="sykmeldinger-list-skeleton">
            ...
            <Skeleton variant="text" height="var(--ax-font-size-heading-xlarge)" width="40%" className="mb-2" />
            <SingleSykmeldingSkeleton />
            <Skeleton variant="text" height="var(--ax-font-size-heading-xlarge)" width="40%" className="mb-2 mt-16" />
...
export function SingleSykmeldingSkeleton({ className, noTag }: { className?: string; noTag?: boolean }): ReactElement {
    return (
        <div className={cn(className, 'flex rounded border border-ax-border-neutral-subtle p-6 max-[560px]:flex-col')}>
