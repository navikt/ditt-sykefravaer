                                ...
                                <g id="Group" mask="url(#mask-2-bjorn)">
                                    <g transform="translate(25.000000, 15.500000)">
                                        <path
                                            ...
                                            id="Fill-29-Copy" stroke="none" fill="#624B7F" fillRule="evenodd" />
                                        <path
                                            ...
                                            id="Fill-44-Copy" stroke="none" fill="#E7E5E2" fillRule="evenodd" />
                                        <g id="Blid-mann-Copy" stroke="none" strokeWidth="1" fill="none"
                                            fillRule="evenodd" transform="translate(16.900000, 22.000000)">
                                            <path
                                            ...
                                            <path d={munnform} id="Stroke-67" stroke="#D19E9C"
                                        ...
                                        <path
                                            ...
                                            id="Stroke-65-Copy" stroke="#D1BFA3" strokeWidth="1.2" fill="none"
                                            strokeLinecap="round" />
                                    </g>
                                </g>
                            </g>
