...
const ServerEnvSchema = z.object({
    ...
    SYFOOPPFOLGINGSPLANSERVICE_HOST: z.string().min(1),
    SYFOOPPFOLGINGSPLANSERVICE_CLIENT_ID: z.string().min(1),
...
export function getServerEnv(): ServerEnv {
    return ServerEnvSchema.parse({
        ...
        SYFOOPPFOLGINGSPLANSERVICE_HOST: process.env.SYFOOPPFOLGINGSPLANSERVICE_HOST,
        SYFOOPPFOLGINGSPLANSERVICE_CLIENT_ID: process.env.SYFOOPPFOLGINGSPLANSERVICE_CLIENT_ID,
