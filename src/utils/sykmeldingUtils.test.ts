...
describe('isActiveSykmelding', () => {
    it('skal være inaktiv hvis status ikke er APEN', () => {
        expect(
            isActiveSykmelding({
                ...minimalSykmelding,
                sykmeldingStatus: {
    ...
    it('skal være inaktiv hvis status er SENDT', () => {
        expect(
            isActiveSykmelding({
                ...minimalSykmelding,
                sykmeldingStatus: {
    ...
    it('skal IKKE være aktiv hvis status er SENDT med merknad UNDER_BEHANDLING', () => {
        expect(
            isActiveSykmelding({
                ...minimalSykmelding,
                sykmeldingStatus: {
    ...
    it('skal være aktiv hvis status er APEN', () => {
        expect(
            isActiveSykmelding({
                ...minimalSykmelding,
                sykmeldingStatus: {
...
describe('getSykmeldingTitle', () => {
    it('Henter standard sykmelding-tittel', () => {
    ...
    it('Henter papirsykmelding-tittel', () => {
        const sykmelding: Sykmelding = {
            ...minimalSykmelding,
...
describe('getSykmeldingStartDate', () => {
    it('Henter fom for den tidligste perioden', () => {
        const sykmelding: Sykmelding = {
            ...minimalSykmelding,
            sykmeldingsperioder: [
...
describe('getSykmeldingEndDate', () => {
    it('Henter tom for den siste perioden', () => {
        const sykmelding: Sykmelding = {
            ...minimalSykmelding,
            sykmeldingsperioder: [
                createSykmeldingPeriode({ fom: '2021-06-01', tom: '2021-06-03' }),
