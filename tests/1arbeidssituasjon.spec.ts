...
test.describe('Tester arbeidssituasjon', () => {
    ...
    test('Bruker med flere arbeidsgivere', async ({ page }) => {
        ...
        await expect(arbeidsgiverAccordion).not.toContainText('Arbeidsgiveren har meldt inn at Albus Dumbledore skal følge deg opp mens du er syk.');
    ...
    test('Har narmesteleder og kan avkrefte den', async ({ page }) => {
        ...
        await expect(situasjonInnhold).toContainText('Arbeidsgiveren har meldt inn at Albus Dumbledore skal følge deg opp mens du er syk.');

        // Click on the accordion item
        const accordionItem = page.locator('.navds-accordion__item').filter({ hasText: 'Slik skal arbeidsgiver hjelpe deg mens du er sykmeldt' });
        ...
        await expect(accordionContent).toContainText('Arbeidsgiveren skal legge til rette for at du kan jobbe helt eller delvis selv om du er syk.');
        ...
        await expect(situasjonInnhold).toContainText('Hogwarts School of Witchcraft and Wizardry');
        await expect(situasjonInnhold).not.toContainText('Arbeidsgiveren har meldt inn at Albus Dumbledore skal følge deg opp mens du er syk.');
        await expect(situasjonInnhold).toContainText('Betaler lønn også etter de 16 første dagene i sykefraværet.');
